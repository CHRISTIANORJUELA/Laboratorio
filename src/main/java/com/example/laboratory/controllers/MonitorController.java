...
public class MonitorController implements Bar4collection1, Initializable {
    ...
    @FXML
    private TableView<aa> tableMonitor;
    @FXML
    ...
    @FXML
    private TableColumn antiquityCL;
    @FXML
    private TableColumn coderoomCL;

    ObservableList<aa> monitors;
    ...
    public void initialize(URL url, ResourceBundle rbs){
        try {
            ...
            this.antiquityCL = new TableColumn<aa, String>("Semester");
            this.antiquityCL.setCellValueFactory(new PropertyValueFactory<aa,String>("semester"));
